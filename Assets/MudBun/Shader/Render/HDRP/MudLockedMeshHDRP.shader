	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord7 = inputMesh.ase_texcoord6;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = inputMesh.ase_texcoord7.xy;
						...
						)
			{
				...
				surfaceDescription.Metallic = packedInput.ase_texcoord8.xy.x;
				...
				surfaceDescription.Smoothness = packedInput.ase_texcoord8.xy.y;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
				outputPackedVaryingsMeshToPS.ase_texcoord2 = inputMesh.ase_texcoord6;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = inputMesh.ase_texcoord7.xy;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3 = inputMesh.ase_texcoord6;
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = inputMesh.ase_texcoord7.xy;
				outputPackedVaryingsMeshToPS.ase_texcoord6 = inputMesh.ase_texcoord6;
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
				outputPackedVaryingsMeshToPS.ase_texcoord9 = inputMesh.ase_texcoord6;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xy = inputMesh.ase_texcoord7.xy;
						...
						)
			{
				...
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = packedInput.ase_texcoord10.xy.x;
				...
				surfaceDescription.Smoothness = packedInput.ase_texcoord10.xy.y;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_20_24;
...
/*ASEBEGIN
Version=18500
-1542;209;1438;795;1653.697;322.839;1.651933;True;False
...
ASEEND*/
//CHKSM=16C372E5A1EA1FD2354EB358F26C4A0CED1DCE45