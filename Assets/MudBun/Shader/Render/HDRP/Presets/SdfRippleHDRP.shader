...
Shader "MudBun/SDF Ripple (HDRP)"
{
	Properties
	{
		...
		[ASEBegin]_TemporarlFrequency("Temporarl Frequency", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				int VertexID4_g1 = inputMesh.ase_vertexID;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5 = vertexToFrag5_g1;
				float vertexToFrag15 = SdfValue4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord6.x = vertexToFrag15;
				float3 vertexToFrag16_g1 = localMudBunMeshPoint4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord6.yzw = vertexToFrag16_g1;
				float3 vertexToFrag27_g2 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag27_g2;
				
				float vertexToFrag8_g1 = Metallic4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord8.x = vertexToFrag8_g1;
				
				float3 vertexToFrag6_g1 = (EmissionHash4_g1).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord8.yzw = vertexToFrag6_g1;
				
				float vertexToFrag7_g1 = Smoothness4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord9.x = vertexToFrag7_g1;
				...
				inputMesh.normalOS = NormalWs4_g1;
						...
						)
			{
				...
				AlphaOut20_g2 = alpha;
				float temp_output_7_0 = ( ( sin( ( ( _SpatialFrequency * 6.283185 * vertexToFrag15 ) + mulTime10 ) ) + 1.0 ) * ( 1.0 - saturate( ( abs( vertexToFrag15 ) / _FadeDistance ) ) ) * AlphaOut20_g2 );
				float temp_output_3_25 = AlphaThreshold20_g2;
				clip( temp_output_7_0 - temp_output_3_25);
				
				float vertexToFrag8_g1 = packedInput.ase_texcoord8.x;
				
				float3 vertexToFrag6_g1 = packedInput.ase_texcoord8.yzw;
				
				float vertexToFrag7_g1 = packedInput.ase_texcoord9.x;
				
				surfaceDescription.Albedo = temp_output_25_0_g1.rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _Metallic * vertexToFrag8_g1 );

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( vertexToFrag6_g1 * (_Emission).rgb );
				surfaceDescription.Smoothness = ( _Smoothness * vertexToFrag7_g1 );
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_7_0;

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = temp_output_3_25;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 vertexToFrag5_g1 = Color4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord = vertexToFrag5_g1;
				float vertexToFrag15 = SdfValue4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord1.x = vertexToFrag15;
				float3 vertexToFrag16_g1 = localMudBunMeshPoint4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord1.yzw = vertexToFrag16_g1;
				float3 vertexToFrag27_g2 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag27_g2;
				
				float vertexToFrag8_g1 = Metallic4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord3.x = vertexToFrag8_g1;
				
				float3 vertexToFrag6_g1 = (EmissionHash4_g1).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord3.yzw = vertexToFrag6_g1;
				
				float vertexToFrag7_g1 = Smoothness4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord4.x = vertexToFrag7_g1;
				
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = inputMesh.ase_vertexID;
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord4.yzw = 0;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 vertexToFrag5_g1 = packedInput.ase_texcoord;
				float4 temp_output_25_0_g1 = ( _Color * vertexToFrag5_g1 );
				float vertexToFrag15 = packedInput.ase_texcoord1.x;
				float mulTime10 = _TimeParameters.x * ( _TemporarlFrequency * -6.283185 );
				float localComputeOpaqueTransparency20_g2 = ( 0.0 );
				float3 vertexToFrag16_g1 = packedInput.ase_texcoord1.yzw;
				float4 unityObjectToClipPos17_g1 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag16_g1));
				float4 computeScreenPos18_g1 = ComputeScreenPos( unityObjectToClipPos17_g1 , _ProjectionParams.x );
				float2 ScreenPos20_g2 = (( ( computeScreenPos18_g1 / (computeScreenPos18_g1).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g2 = packedInput.ase_texcoord2.xyz;
				float3 VertPos20_g2 = vertexToFrag27_g2;
				int VertexID4_g1 = packedInput.ase_texcoord2.w;
				float3 PositionLs4_g1 = float3( 0,0,0 );
				float3 NormalWs4_g1 = float3( 0,0,0 );
				float3 NormalLs4_g1 = float3( 0,0,0 );
				float4 Color4_g1 = float4( 0,0,0,0 );
				...
				float vertexToFrag8_g1 = packedInput.ase_texcoord3.x;
				
				float3 vertexToFrag6_g1 = packedInput.ase_texcoord3.yzw;
				
				float vertexToFrag7_g1 = packedInput.ase_texcoord4.x;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag27_g2;
				float4 vertexToFrag5_g1 = Color4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord3 = vertexToFrag5_g1;
					...
					)
			{
				...
				float3 localMudBunMeshPoint4_g1 = MudBunMeshPoint( VertexID4_g1 , PositionLs4_g1 , NormalWs4_g1 , NormalLs4_g1 , Color4_g1 , EmissionHash4_g1 , Metallic4_g1 , Smoothness4_g1 , TextureWeight4_g1 , SdfValue4_g1 , Outward2dNormalLs4_g1 , Outward2dNormalWs4_g1 );
				float Hash20_g2 = (EmissionHash4_g1).w;
				float4 vertexToFrag5_g1 = packedInput.ase_texcoord3;
				float4 temp_output_25_0_g1 = ( _Color * vertexToFrag5_g1 );
				float AlphaIn20_g2 = (temp_output_25_0_g1).a;
				float AlphaOut20_g2 = 0;
				float AlphaThreshold20_g2 = 0;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float vertexToFrag7_g1 = Smoothness4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord3.x = vertexToFrag7_g1;
				
				float vertexToFrag15 = SdfValue4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord3.y = vertexToFrag15;
				float3 vertexToFrag16_g1 = localMudBunMeshPoint4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag16_g1;
				float3 vertexToFrag27_g2 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag27_g2;
				float4 vertexToFrag5_g1 = Color4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord6 = vertexToFrag5_g1;
					...
					)
			{
				...
				float vertexToFrag7_g1 = packedInput.ase_texcoord3.x;
				
				float vertexToFrag15 = packedInput.ase_texcoord3.y;
				float mulTime10 = _TimeParameters.x * ( _TemporarlFrequency * -6.283185 );
				float localComputeOpaqueTransparency20_g2 = ( 0.0 );
				float3 vertexToFrag16_g1 = packedInput.ase_texcoord4.xyz;
				float4 unityObjectToClipPos17_g1 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag16_g1));
				float4 computeScreenPos18_g1 = ComputeScreenPos( unityObjectToClipPos17_g1 , _ProjectionParams.x );
				float2 ScreenPos20_g2 = (( ( computeScreenPos18_g1 / (computeScreenPos18_g1).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g2 = packedInput.ase_texcoord5.xyz;
				float3 VertPos20_g2 = vertexToFrag27_g2;
				int VertexID4_g1 = packedInput.ase_texcoord3.z;
				float3 PositionLs4_g1 = float3( 0,0,0 );
				float3 NormalWs4_g1 = float3( 0,0,0 );
				float3 NormalLs4_g1 = float3( 0,0,0 );
				float4 Color4_g1 = float4( 0,0,0,0 );
				...
				float3 localMudBunMeshPoint4_g1 = MudBunMeshPoint( VertexID4_g1 , PositionLs4_g1 , NormalWs4_g1 , NormalLs4_g1 , Color4_g1 , EmissionHash4_g1 , Metallic4_g1 , Smoothness4_g1 , TextureWeight4_g1 , SdfValue4_g1 , Outward2dNormalLs4_g1 , Outward2dNormalWs4_g1 );
				float Hash20_g2 = (EmissionHash4_g1).w;
				float4 vertexToFrag5_g1 = packedInput.ase_texcoord6;
				float4 temp_output_25_0_g1 = ( _Color * vertexToFrag5_g1 );
				float AlphaIn20_g2 = (temp_output_25_0_g1).a;
				float AlphaOut20_g2 = 0;
				float AlphaThreshold20_g2 = 0;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 vertexToFrag5_g1 = Color4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord7 = vertexToFrag5_g1;
				float vertexToFrag15 = SdfValue4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord8.x = vertexToFrag15;
				float3 vertexToFrag16_g1 = localMudBunMeshPoint4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord8.yzw = vertexToFrag16_g1;
				float3 vertexToFrag27_g2 = float3( 0,0,0 );
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag27_g2;
				
				float vertexToFrag8_g1 = Metallic4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord10.x = vertexToFrag8_g1;
				
				float3 vertexToFrag6_g1 = (EmissionHash4_g1).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord10.yzw = vertexToFrag6_g1;
				
				float vertexToFrag7_g1 = Smoothness4_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord11.x = vertexToFrag7_g1;
				
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = inputMesh.ase_vertexID;
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord11.yzw = 0;
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 vertexToFrag5_g1 = packedInput.ase_texcoord7;
				float4 temp_output_25_0_g1 = ( _Color * vertexToFrag5_g1 );
				float vertexToFrag15 = packedInput.ase_texcoord8.x;
				float mulTime10 = _TimeParameters.x * ( _TemporarlFrequency * -6.283185 );
				float localComputeOpaqueTransparency20_g2 = ( 0.0 );
				float3 vertexToFrag16_g1 = packedInput.ase_texcoord8.yzw;
				float4 unityObjectToClipPos17_g1 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag16_g1));
				float4 computeScreenPos18_g1 = ComputeScreenPos( unityObjectToClipPos17_g1 , _ProjectionParams.x );
				float2 ScreenPos20_g2 = (( ( computeScreenPos18_g1 / (computeScreenPos18_g1).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g2 = packedInput.ase_texcoord9.xyz;
				float3 VertPos20_g2 = vertexToFrag27_g2;
				int VertexID4_g1 = packedInput.ase_texcoord9.w;
				float3 PositionLs4_g1 = float3( 0,0,0 );
				float3 NormalWs4_g1 = float3( 0,0,0 );
				float3 NormalLs4_g1 = float3( 0,0,0 );
				float4 Color4_g1 = float4( 0,0,0,0 );
				...
				float vertexToFrag8_g1 = packedInput.ase_texcoord10.x;
				
				float3 vertexToFrag6_g1 = packedInput.ase_texcoord10.yzw;
				
				float vertexToFrag7_g1 = packedInput.ase_texcoord11.x;
...
/*ASEBEGIN
Version=18500
-1542;209;1438;795;876.6564;69.81284;1.657553;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;27;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;28;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;29;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;33;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;0;True;-28;False;True;True;True;True;True;0;True;-44;False;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;31;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;32;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;23;1280,0;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;MudBun/SDF Ripple (HDRP);53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;0;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;24;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;25;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;26;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;30;1280,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;1;False;-1;False;True;True;True;True;True;0;True;-44;False;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;False;0
...
WireConnection;23;4;1;11
WireConnection;23;6;1;10
WireConnection;23;7;1;12
WireConnection;23;9;7;0
WireConnection;23;10;3;25
WireConnection;23;11;1;0
WireConnection;23;12;1;2
ASEEND*/
//CHKSM=2D6DF9507ADC22771E3108DB72D96707194AA0B8